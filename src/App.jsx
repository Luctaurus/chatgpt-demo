...
function ScrollToBottom() {
    ...
    if (isAtBottom) {
        ...
        return (<div className='cursor-pointer absolute z-10 text-[#5d5d5d] bg-[#ffffff] rounded-full bg-clip-padding border right-1/2 translate-x-1/2 w-8 h-8 flex items-center justify-center bottom-5' onClick={() => scrollToBottom()}>
				<IconButton>
					<ArrowDownwardIcon />
				</IconButton>
			</div>);
...
const App = () => {
    ...
    const addChat = (apiKey, content) => {
        ...
        const initAssistantMessage = { role: "assistant", content: "", pending: true };
